...
wd = webdriver.Chrome("D:\project\python\WoC\practice\chromedriver-win64\chromedriver.exe")  # Change the path to your chromedriver executable
download_path = "imgs"
...
for breed_query, breed_directory in breeds.items():
    urls = get_images_for_breed(wd, 1, 6, breed_query, os.path.join(download_path, breed_directory))
